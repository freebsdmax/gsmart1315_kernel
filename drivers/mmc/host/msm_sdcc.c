 ...
 */
/*
 * [WIFI] Enable Wi-Fi Support, Please reference KernelConfig -> Device Drivers ->
 *  Network device support -> Wireless LAN -> Atheros AR6K... AND "HELP".
 */
...
{
#ifndef WLAN_ATH_AR6K_SDIO_PATCH /* [WIFI] Wi-Fi Support patch ATHENV ++ */
	/* Fix init MMC0 assert "SDIO Wake up IRQ" kernel panic on MSM7627 */
	struct msmsdcc_host	*host = dev_id;
	...
	spin_unlock(&host->lock);
#endif /* !WLAN_ATH_AR6K_SDIO_PATCH [WIFI] Wi-Fi Support patch ATHENV -- */
...
#ifdef WLAN_ATH_AR6K_SDIO_PATCH /* [WIFI] Wi-Fi Support patch ATHENV ++ */
static ssize_t
