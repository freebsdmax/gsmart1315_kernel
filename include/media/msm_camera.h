...
#define CAMERA_CONTRAST_LV1			2
#define CAMERA_CONTRAST_LV2			4
#define CAMERA_CONTRAST_LV3			6
#define CAMERA_CONTRAST_LV4			8
#define CAMERA_CONTRAST_LV5			10

#define CAMERA_BRIGHTNESS_LV0			12
#define CAMERA_BRIGHTNESS_LV1			6
#define CAMERA_BRIGHTNESS_LV2			0
#define CAMERA_BRIGHTNESS_LV3			-6
#define CAMERA_BRIGHTNESS_LV4			-12

#define CAMERA_SATURATION_LV0			0
#define CAMERA_SATURATION_LV1			2
#define CAMERA_SATURATION_LV2			4
#define CAMERA_SATURATION_LV3			6
#define CAMERA_SATURATION_LV4			8
#define CAMERA_SATURATION_LV5			10

#define CAMERA_SHARPNESS_LV0		0
#define CAMERA_SHARPNESS_LV1		6
#define CAMERA_SHARPNESS_LV2		12
#define CAMERA_SHARPNESS_LV3		18
#define CAMERA_SHARPNESS_LV4		24
#define CAMERA_SHARPNESS_LV5		30
...
#define i2c_add_driver hack_i2c_add_driver
