...
static unsigned wlan_config_power_on[] = {
        /* WLAN_RST_L */
        GPIO_CFG(GPIO_WLAN_RST_L, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),
        /* WLAN_WAKES_MSM */
        GPIO_CFG(GPIO_WLAN_WAKES_MSM, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA),
        /* CHIP_PWD_L */
        GPIO_CFG(GPIO_WLAN_CHIP_PWD_L, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA)
};
